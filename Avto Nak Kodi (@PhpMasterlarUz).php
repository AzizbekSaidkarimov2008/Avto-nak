<?php
// Ushbu kod @PHPbilan kanali orqali tarqatildi agar manbasiz ko'rsam bot ulangan api o'chiriladi va bot ishlamaydi.
ob_start();
define('API_KEY',
"5626966724:AAE3AqUJzceDAnmfcuv1bTVemK2Rk7kNRx8");
$admin = '5005025566';
...
$kanalim = 'obunachi_1';
$adminuser = 'Abdulaziz_Coder';
$rek = "Ushbu bot @Abdulaziz_Coder tomonidan yaratildi. Shaxsiy botingizga ega bo'lish uchun @Abdulaziz_Coder ga murojaat qiling";
...
🌟 Sizning sahifalaringizni obunachilari professional darajada ko'paytirish uchun @UzbNakrutka_bot Official siz bilan birga!
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"🎛Bot Yaratish",'url'=>"https://t.me/Abdulaziz_coder"]],
]]),]);}
if($data=="qol"){
bot('editMessagetext',[
'chat_id'=>$callcid,
...
bot('sendmessage',[
'chat_id'=>$cid,
'text'=>"Assalomu aleykum🕹️Bot yaratish👾 bo'limiga xush kelibsiz🤗
Shaxsiy botingizga ega bo'lish uchun @Janob_0o ga murojaat qilishingiz mumkin",
]);
}
